...
from .views import AdminProfessionalVerificationListView, AdminValidateProfessionalView, SubmitProfessionalVerificationView, UploadVerificationDocumentsView,UserVerificationListView, ValidateUserView,CollectorListView, CollectorScheduleViewSet, UserProfileUpdateView
